                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6">
                            <label for="attendanceSection" class="form-label">Section <span
                                    class="text-danger">*</span></label>
                            <x-select-vanilla id="attendanceSection" name="section_ids" placeholder="Select Section(s)"
                                :options="[]" :searchable="true" :multiple="true" />
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control flatpickr flatpickr-input" id="attendanceDate"
                        ...
                        <!-- Start Time -->
                        <div class="col-lg-6">
                            <label for="attendanceStartTime" class="form-label">Start Time <small class="text-muted">(at
                                    least one required)</small></label>
                            <div class="input-group">
                                <input type="text" class="form-control flatpickr flatpickr-input"
                                    id="attendanceStartTime" name="start_time" placeholder="Select start time" readonly>
                        ...
                        <div class="col-lg-6">
                            <label for="attendanceEndTime" class="form-label">End Time <small class="text-muted">(at
                                    least one required)</small></label>
                            <div class="input-group">
                                <input type="text" class="form-control flatpickr flatpickr-input" id="attendanceEndTime"
                                    name="end_time" placeholder="Select end time" readonly>
                                <span class="input-group-text"><i class="ri-time-line"></i></span>
                            </div>
                        ...
                        <!-- Location -->
                        <div class="col-lg-12">
                            <label for="attendanceLocation" class="form-label">Location <small class="text-muted">(at
                                    least one required)</small></label>
                        ...
                        <div class="col-lg-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="attendanceIsActive" name="is_active"
                                    checked>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-check form-switch form-switch-lg mt-2">
                                <input class="form-check-input" type="checkbox" id="categoryIsActive" name="is_active"
                                    checked>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                    ...
                    <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                        <h4>Are you sure ?</h4>
                        <p class="text-muted mx-4 mb-0">Are you sure you want to delete this attendance session? This
                            action
                ...
                <div id="studentsContent" class="d-none">
                    ...
                    <div class="mb-3">
                        <div class="input-group">
                            ...
                            <button class="btn btn-light" type="button" id="clearStudentsSearch" style="display: none;">
                    ...
                    <!-- Pagination -->
                    <div class="d-flex justify-content-between align-items-center mt-3" id="studentsPaginationContainer"
