<x-modal id="invite-user-modal" wire:model="showInviteModal" overflow="visible" :title="$userId ? 'Edit User' : 'Invite User'" size="lg" :centered="true" vertical-align="center" :show-footer="true">
